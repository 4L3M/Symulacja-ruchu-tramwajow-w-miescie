...
public class CTram extends CAbstractTram implements Objects{
    ...
    @Override
    public void drawMe(Graphics2D G2D) {                            // rysuje tramwaj na panelu
    ...
    @Override
    public boolean checkIfCanGo(){                                  // sprawdza czy tramwaj moze sie przemieszczac
        boolean b = true;
    ...
    @Override
    public void saveToStats() {                                     // zapisz spoznienie do linii
