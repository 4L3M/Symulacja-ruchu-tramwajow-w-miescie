...
public class CPlatform extends CStop implements Objects{
    ...
    public CPlatform(String position, String controlPosition) {         // konstruktor
    ...
    public void drawMe (Graphics2D G2D) {                               // rysowanie wszystkich pozycji na panelu
    ...
    boolean checkifcango(CTram tram){
        CPosition position = tram.headPosition();                       // zwraca czy tramwaj moze sie dalej przemieszczac (zatrzymuje i uruchamia tramwaj)
    ...
    public void changetime(int currentTime) {                           // dekrementuje licznik odpowiedzialny za czas zatrzymania tramwaju
        counter--;
    }
}