...
public class CClock {
    ...
    public CClock(int hour, int minute, int second) {               //inicjacja konstruktora
        this.second = second;
        this.hour = hour;
        this.minute = minute;
    }
    public String getTime (){                                       // zwraca aktualna godzine sformatowana w lancuch znakow w formacie h:m:s
        return hour + ":" + minute + ":" + second;
    }
    public void tikTak (){                                          // wykonuje tykniecie zegara (przyjeto ze zegar podczas jednego "tykniecia" przesuwa sie o 10s)
        second += 10;
   ...
   public boolean isTimeEqual(String departureTime){                // sprawdza czy podana godzina jest rowna z aktualna
      int hC, mC, sC;
