...
public class CTrafficLights extends CStop implements Objects{
    ...
    public void drawMe (Graphics2D G2D){                        // wyrysowanie odpowiedniego koloru swiatla jako symbol na mapie
        if(colour){
    ...
    boolean checkIfCanGo(CPosition position){                   // zatrzymuje i uruchamia tramwaj
    ...
    public void changeTime(int currentTime) {                   // ustawia kolory swiatel w zaleznosci od czasu
